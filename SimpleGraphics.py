...
#
#    * Resizes seems to fail on occassion.  The program that displays 
...
#  @param x the x part of the coordiante of the upper left corner
#  @param y the y part of the coordiante of the upper left corner
...
#  @param x the x part of the coordiante of the where the text will be placed
#  @param y the y part of the coordiante of the where the text will be placed
...
#        should be seperated by spaces such as "bold italic"
...
# @param the image to examin, or None which indates that the width of the
...
# @param the image to examin, or None which indates that the height of the
#        window should be returned
# @param the height
...
#  @param fname the name of the file that will be written (noramlly ends with
#         .eps)
def saveEPS(fname):
